...
checkpoint create_paths_for_manually_checking:
    ...
    script:
        "../scripts/create_paths_for_manually_checking.py"
...
rule cp_no_personal_data_found:
    ...
    output:
        report("results/{id}/to-check/no_personal_data_found/{img}", caption="../report/test.rst", category="No Data Found", subcategory="{id}")
    log:
...
rule cp_lots_personal_data_found:
    input:
        "results/{id}/processed-docs/{img}",
    output:
        report("results/{id}/to-check/lots_personal_data_found/{img}", caption="../report/test.rst", category="Lot of Data Found", subcategory="{id}")
    log:
...
rule cp_address_not_entirely_found:
    input:
        "results/{id}/processed-docs/{img}",
    output:
        report("results/{id}/to-check/address_not_entirely_found/{img}", caption="../report/test.rst", category="Address Not Entirely Found", subcategory="{id}")
    log:
...
rule cp_name_not_entirely_found:
    input:
        "results/{id}/processed-docs/{img}",
    output:
        report("results/{id}/to-check/name_not_entirely_found/{img}", caption="../report/test.rst", category="Name Not Entirely Found", subcategory="{id}")
    log:
...
rule move_questionable_imgs:
    input:
        lambda wildcards: get_questionable_imgs(wildcards, case="no_personal_data_found"),
        lambda wildcards: get_questionable_imgs(wildcards, case="lots_personal_data_found"),
        lambda wildcards: get_questionable_imgs(wildcards, case="address_not_entirely_found"),
        lambda wildcards: get_questionable_imgs(wildcards, case="name_not_entirely_found"),
    output:
